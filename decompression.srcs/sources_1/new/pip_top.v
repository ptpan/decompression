...
module decompression(
    ...
    output      [255:0]         axis_tdata_c2s, 
    output      [31:0]          axis_tkeep_c2s, 
...
wire cursor_aresetn = axis_aresetn & ((length == 128) ? 1'b0 : 1'b1);
wire [15:0] bitmap;
wire [127:0] offset;
